...
var main = function () {
	...
	var toDos = [
		"Посмотреть список групп ИКТЗИ",
		"Посмотреть список групп ИАНТЭ",
		"Посмотреть список групп ИАЭП",
		"Посмотреть список групп ИРЭФ - ЦТ",
		"Посмотреть список групп ФМФ",
		"Посмотреть список групп ВШПИТ",
		"Посмотреть список групп ИИЭиП",
	];
